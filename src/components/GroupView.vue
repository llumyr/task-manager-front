    ...
    <div class="group__wrapper">
      <div class="group__header">
        <div class="group__activeGroup activeGroup">
          <h2 class="activeGroup__title">{{ activeGroup ? activeGroup.title : 'To start, select a group...' }}</h2>
          <div class="activeGroup__actions" v-if="activeGroup">
            <button type="button" class="activeGroup__edit">
